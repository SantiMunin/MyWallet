...
public class CashFlowServiceTest extends AndroidTestCase {
	...
	public void testCreateExists() throws DuplicateEntryException {
		CashFlow cash = new CashFlow(-1, "TestConcept", (float) 1.6, new Category(id), new Date(), new Date(), Period.ONCE, MovementType.SPEND);
	...
	public void testGetUpdate() throws EntryNotFoundException, DuplicateEntryException {
		Date now = new Date();
		CashFlow c = new CashFlow(-1, "TestConcept", (float) 1.6, new Category(id), now, now, Period.ONCE, MovementType.SPEND);
	...
	public void testGetAll() throws DuplicateEntryException {
		CashFlow c = new CashFlow(-1, "TestConcept", (float) 1.6, new Category(id), new Date(), new Date(), Period.ONCE, MovementType.SPEND);
		CashFlow c2 = new CashFlow(-1, "TestConcept", (float) 1.8, new Category(id), new Date(), new Date(), Period.ONCE, MovementType.SPEND);
		this.service.add(c);
		this.service.add(c2);
